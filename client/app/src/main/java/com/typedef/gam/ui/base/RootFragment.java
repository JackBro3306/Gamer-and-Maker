 ...
 * 根据数据加载状态，显示不同的界面
 */
public abstract class RootFragment<T extends IPresenter> extends BaseMvpFragment<T> {
    ...
    protected void initEventAndData() {
        if(getView() == null)
            return;
        contentView = getView().findViewById(R.id.view_main);
        if (contentView == null) {
...
//                ivLoading.stop();
    ...
    public abstract void jumpToTheTop();
